...
3.17 Click on Continue button
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        myAccountsPage.clickOnMyAccountLink();
        myAccountsPage.selectMyAccountOptions("Register");
        myAccountsPage.enterFirstName("Dhyana");
        myAccountsPage.enterLastName("Jadeja");
        myAccountsPage.enterEmailId("dhyJ123" + getAlphaNumericString(3) + "@gmail.com");
        myAccountsPage.enterPhoneNumber("1234567890");
        myAccountsPage.enterPassword("dhyc123");
        myAccountsPage.enterConfirmPassword("dhyc123");
